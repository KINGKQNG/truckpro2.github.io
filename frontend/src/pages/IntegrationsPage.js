        ...
        <Dialog>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription data-testid="integration-dialog-description">Configure a new integration endpoint and credentials for sync operations.</DialogDescription>
            </DialogHeader>
